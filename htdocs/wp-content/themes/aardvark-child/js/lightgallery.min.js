  ...
  * Copyright (c) 2020 Sachin N; Licensed GPLv3 */
  ...
  (function() {
      ...
      Thumbnail.prototype.build = function() {
          ...
          function getThumb(src, thumb, index, thumbType = "") {
              ...
              if(thumbType != ""){
                thumbList += '<div data-vimeo-id="' + vimeoId + '" class="lg-thumb-item" style="width:' + _this.core.s.thumbWidth + 'px; height: ' + _this.core.s.thumbHeight + '; margin-right: ' + _this.core.s.thumbMargin + 'px"><video muted autoplay loop><source src="'+thumbImg+'" type="video/'+thumbType+'"></video></div>';
              } else {
          ...
          if (_this.core.s.dynamic) {
              ...
              _this.core.$items.each(function(i) {
                  ...
                  if (!_this.core.s.exThumbImage) {
                      ...
                      getThumb($(this).attr('href') || $(this).attr('data-src'), $(this).attr(_this.core.s.exThumbImage), i, $(this).attr('data-exthumbtype') || "");
                  }
